 <template>
  <div class="w-full h-full">
    <div class="rounded-xl mt-4 lg:hidden">
      ...
      >
        <div 
          class="w-16 h-full bg-gray-400 absolute top-0 rounded-lg transform duration-300"
    ...
    <div class="overflow-hidden h-full lg">
...
export default {
  name: 'Home',
  components: { LineChartsContainer, CandlestickChart, SideBar },
  data() {
    return {
