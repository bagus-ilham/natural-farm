<template>
  ...
  <div class="fixed lg:static bottom-0 w-full lg:w-20 lg:h-full z-10" role="navigation">
    <!-- rounded-t-full -->
    <div class="relative w-full lg:w-20 h-full rounded-full lg:rounded-none bg-gray-800">
